...
```
В корне проекта можно создать файл .env в котором имеется возможность переопределить название json файла по умолчанию
с помощью переменной FILE_NAME. Пример:
